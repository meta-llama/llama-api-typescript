...
[![NPM version](https://img.shields.io/npm/v/llama_api.svg)](https://npmjs.org/package/llama_api) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/llama_api)
...
> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install llama_api`
...
<!-- prettier-ignore -->
```js
import LlamaAPI from 'llama_api';
...
```ts
import LlamaAPI from 'npm:llama_api';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/llama-api-typescript/issues) with questions, bugs, or suggestions.
