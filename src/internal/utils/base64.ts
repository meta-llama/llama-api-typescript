...
export const toBase64 = (data: string | Uint8Array | null | undefined): string => {
  ...
  throw new LlamaAPIError('Cannot generate base64 string; Expected `Buffer` or `btoa` to be defined');
};
...
export const fromBase64 = (str: string): Uint8Array => {
  ...
  throw new LlamaAPIError('Cannot decode base64 string; Expected `Buffer` or `atob` to be defined');
};
