...
import { UploadCreateParams, UploadCreateResponse, UploadGetParams, UploadGetResponse, UploadPartParams, UploadPartResponse, Uploads as UploadsAPIUploads } from './resources/uploads';
import { Chat, CompletionMessage, CreateChatCompletionResponse, CreateChatCompletionResponseStreamChunk, Message, MessageImageContentItem, MessageTextContentItem, SystemMessage, ToolResponseMessage, UserMessage } from './resources/chat/chat';
...
export class LlamaAPIClient {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? LlamaAPIClient.DEFAULT_TIMEOUT /* 10 minutes */;
    this.logger = options.logger ?? console;
    const defaultLogLevel = 'warn';
    // Set default logLevel early so that we can log a warning in parseLogLevel.
    this.logLevel = defaultLogLevel;
    this.logLevel = parseLogLevel(options.logLevel, 'ClientOptions.logLevel', this) ?? parseLogLevel(readEnv('LLAMA_API_CLIENT_LOG'), 'process.env[\'LLAMA_API_CLIENT_LOG\']', this) ?? defaultLogLevel;
